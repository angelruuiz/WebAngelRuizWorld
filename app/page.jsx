            ...
            <div className="max-w-5xl mx-auto relative">
                <div className="pt-12 overflow-hidden">
                    ...
                    <div className="relative flex overflow-hidden py-4 border-y border-amber-500/10">
                        <div className="flex gap-x-16 whitespace-nowrap animate-marquee">
                            <div className="flex gap-x-16 text-sm md:text-lg uppercase tracking-[0.3em] font-bold text-amber-400">
                            ...
                            <div className="flex gap-x-16 text-sm md:text-lg uppercase tracking-[0.3em] font-bold text-amber-400 ml-16">
                                <span>Mago de Cerca Madrid</span>
                                <span>Mentalismo Profesional</span>
                                <span>Magia para Bodas</span>
                                <span>Eventos de Empresa</span>
                ...
                <div className="mt-24 grid grid-cols-1 md:grid-cols-2 gap-12 border-t border-white/5 pt-16">
                    <div className="space-y-6 text-justify">
                        <h2 className="text-white font-[Cinzel] text-xl md:text-2xl uppercase tracking-widest text-left">Mago e Ilusionista en Madrid</h2>
                        <p className="text-sm opacity-60 italic text-left">Referente del ilusionismo exclusivo para eventos inolvidables.</p>
