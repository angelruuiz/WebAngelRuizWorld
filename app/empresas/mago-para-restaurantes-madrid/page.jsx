...
export const metadata = {
  title: 'Mago para Restaurantes y Locales en Madrid | Impacto B2B',
  description: 'Descubre cómo potenciar tu evento corporativo con nuestro Mago para Restaurantes y Locales. Metodología brutalista B2B, alta retención y ROI garantizado.',
};
      ...
      <header className="relative pt-32 pb-20 border-b border-white/10 overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto px-6 relative z-10">
          ...
          <h1 className="text-5xl md:text-7xl font-bold text-white tracking-tighter mb-6 uppercase">
            Mago para Restaurantes y Locales <br/> <span className="text-amber-500 block mt-2">ALTO IMPACTO MADRID</span>
          </h1>
      ...
      <section className="py-24 border-b border-white/10 bg-[#0C0C0C]">
        <div className="max-w-4xl mx-auto px-6 prose prose-invert prose-amber max-w-none">
          <div className="font-mono text-amber-500 mb-8 border-l-2 border-amber-500 pl-4 py-1">
            [ DOCUMENTACIÓN TÉCNICA: ANIMACIÓN EN RESTAURANTE ]
          </div>
          ...
          <p className="text-lg text-slate-400 leading-relaxed mb-6">
            La ciudad de Madrid alberga algunos de los eventos, ferias (como IFEMA) y convenciones más importantes de Europa. Destacar en este ruido requiere más que un buen stand o una buena cena. Requiere una disrupción cognitiva. Convertimos tu <em>animación en restaurante</em> en el epicentro del evento, el lugar donde se cierran los tratos y se genera el verdadero networking.
          </p>
