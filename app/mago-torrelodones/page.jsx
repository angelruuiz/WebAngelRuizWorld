        ...
        <div className="relative w-full h-full">
            <AnimatePresence mode="popLayout">
                ...
                >
                    <Image
                        src={images[index]}
                        alt="Ángel Ruiz | Mago e Ilusionista profesional en Torrelodones"
                        fill
...
export default function MagoTorrelodonesPage() {
    ...
    const breadcrumbSchema = {
        ...
        "itemListElement": [
            ...
            { "@type": "ListItem", "position": 2, "name": "Mago Torrelodones", "item": "https://angelruiz.world/mago-torrelodones" }
        ]
    };
                    ...
                    <section className="bg-slate-900/40 p-8 rounded-2xl border border-white/5 mb-16">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                            ...
                            <div className="space-y-4">
                                ...
                                <p className="text-slate-400 text-justify text-sm leading-relaxed mb-4">
                                ...
                                <div className="flex flex-wrap gap-2 text-[10px] uppercase tracking-tighter opacity-70">
                                    <span className="text-white/40 mr-1">Otras zonas:</span>
                                    <a href="/mago-galapagar" className="hover:text-amber-500 transition-colors">Galapagar</a>
                                    <a href="/mago-las-rozas" className="hover:text-amber-500 transition-colors">Las Rozas</a>
                                    <a href="/mago-majadahonda" className="hover:text-amber-500 transition-colors">Majadahonda</a>
                                    <a href="/mago-pozuelo" className="hover:text-amber-500 transition-colors">Pozuelo</a>
                                    <a href="/mago-boadilla" className="hover:text-amber-500 transition-colors">Boadilla</a>
                                </div>
                            </div>
                        </div>
                    </section>
