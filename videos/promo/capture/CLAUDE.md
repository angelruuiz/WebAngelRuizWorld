# Ángel Ruiz | Mago Profesional en Madrid para Bodas y Empresas

Source: https://angelruiz.world
...
| `extracted/tokens.json` | Design tokens: 16 colors, 3 fonts, 12 headings, 0 CTAs |
...
- **Colors**: #020617 (bg-dark), #E2E8F0 (bg-light), #F59E0B (accent), #E5E7EB (bg-light), #CBD5E1 (surface-light), #0F172A (accent), #FFFFFF (bg-light), #F1F5F9 (bg-light), #94A3B8 (neutral), #FBBF24 (surface-light)
- **Fonts**: __Cinzel_a5db66 (400-900 variable), __Playfair_Display_0a80b4 (400-900 variable), __Inter_f367f3 (100-900 variable)
