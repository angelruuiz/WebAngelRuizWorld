...
export function ParpellComparisonTable() {
  return (
    ...
    >
      ...
      <div className="w-full max-w-3xl mx-auto rounded-3xl overflow-hidden shadow-2xl shadow-black/80 border border-white/[0.10] bg-[#0E0511]/90 backdrop-blur-2xl">
        {/* Dark Obsidian Header */}
        <div className="bg-[#17081A] px-6 sm:px-8 py-4 sm:py-5 flex items-center justify-between border-b border-white/[0.08]">
          <div className="w-1/2 sm:w-7/12 text-left" />

          <div className="w-1/4 sm:w-2.5/12 text-center">
            <span className="inline-block px-3 py-1 rounded-full text-xs sm:text-sm font-extrabold tracking-wider text-[#E598A8] bg-[#9E5C6A]/25 border border-[#9E5C6A]/40 uppercase font-mono shadow-[0_0_15px_rgba(158,92,106,0.3)]">
              PARPELL
            </span>
          </div>
        ...
        <div className="divide-y divide-white/[0.06] text-left">
          {comparisonData.map((row, idx) => (
            <div
              key={idx}
              className={`px-6 sm:px-8 py-4 sm:py-4.5 flex items-center justify-between transition-colors ${
                row.highlight
            ...
            >
              {/* Feature Title */}
              <div className="w-1/2 sm:w-7/12 text-left pr-4">
              ...
              <div className="w-1/4 sm:w-2.5/12 text-center flex justify-center items-center">
                <div className="w-7 h-7 rounded-full bg-[#9E5C6A]/25 border border-[#9E5C6A]/50 flex items-center justify-center text-[#F3B0BE] shadow-[0_0_12px_rgba(158,92,106,0.35)]">
              ...
              <div className="w-1/4 sm:w-2.5/12 text-center flex justify-center items-center">
                <span className="text-zinc-600 font-bold text-base leading-none select-none">
                  —
                </span>
              </div>
            </div>
        ...
        <div className="bg-[#140718] px-6 sm:px-8 py-5 border-t border-white/[0.08] flex flex-col sm:flex-row items-center justify-between gap-4">
