      ...
      <div className="fixed bottom-6 right-6 z-[99999] flex flex-col items-end">
        ...
        {!isOpen && (
          <motion.button 
            ...
            className="bg-amber-500 hover:bg-amber-400 text-slate-900 rounded-full px-5 py-3 shadow-lg flex items-center gap-2 transform transition-all active:scale-95 cursor-pointer"
          >
            <span className="font-bold text-xs uppercase tracking-wider">Asistente Mágico</span>
