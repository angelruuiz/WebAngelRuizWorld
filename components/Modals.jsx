        ...
        <MagicModal isOpen={isOpen} onClose={onClose}>
            <div className="p-6 md:p-10 text-left">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <button type="submit" disabled={status === "submitting"} className="w-full bg-gradient-to-r from-[#d4a853] to-[#b8860b] text-[#030712] font-bold py-3 md:py-4 rounded-lg hover:from-[#e8cc8a] transition-all uppercase tracking-widest text-xs md:text-sm shadow-lg shadow-[#d4a853]/10 flex items-center justify-center gap-2 mt-4">
